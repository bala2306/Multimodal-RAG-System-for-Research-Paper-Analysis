...
import { uploadBasic } from '../services/api'

function BasicIngestion() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const data = await uploadBasic(file, setProgress)
            setResult(data)
            setFile(null)
        } catch (err) {
    ...
    return (
        <div className="card">
            <h2>📄 Basic Ingestion</h2>
            <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem' }}>
                Simple PDF text extraction with fixed-size chunking
            </p>
            ...
            {result && (
                <div className="alert alert-success mt-3">
                    <h3 style={{ marginBottom: '1rem' }}>✅ Upload Successful!</h3>
